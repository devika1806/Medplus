<?php
  ...
  include_once("db.php");
  $sql_get=mysqli_query($conn,"SELECT * FROM need_med WHERE status=0");
...
<html>
  ...
  <i class="fa-solid fa-bell"></i><span class="badge bg-secondary"><?php echo $count; ?></span>
  </button>
       
  
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <?php
      $sql_get1=mysqli_query($conn,"SELECT * FROM need_med WHERE status=0");
      if(mysqli_num_rows($sql_get1)>0)
      {
        while($result=mysqli_fetch_assoc($sql_get1))
        {
          echo '<a class="dropdown-item text-danger font-weight-bold" href="read_msg.php?id='.$result['id'].'">'.$result['fname'].'</a>';
    ...
    <!-- <li><a class="dropdown-item" href="#">Action</a></li> -->
        ...
        <li>
          ...
          <ul>
            ...
            <li><a href="#">Donated Medicine</a></li>
            <li><a href="volunteer_list.php">Volunteer list</a></li>
